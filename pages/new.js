...
<meta property="twitter:image" content="https://www.dynamicssquare.ca/img/banner-head-image.png" />
 ...
 <script
   ...
   <section id="hero" className="">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-7">
              ...
              <p style={{textAlign:'center'}}>We simplify your business and bring scalable growth through innovative Microsoft Cloud solutions. Get your business problems solved today.</p>
              <div>
    ...
    <section className='bg-cd'>
    <div className="gradient-background"> </div>
    <video
                  className="video-screenss"
                  autoPlay
                  loop
                  muted
                  poster="/img/video-thumb.png"
                >
                  <source src="/video/Framew.mp4" />
                </video>
     ...
     <div className='dashboard-lines-item dashboard-lines-item-active'>
        <div>
