          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <div className="custom-p-001">
                <p className="ne4">
                Stay aware of your competition with our top-notch Microsoft cloud, <Link href="/products/microsoft-azure/">Microsoft Azure</Link>, <Link href="/products/microsoft-dynamics-365-ai/">(Artificial Intelligence)</Link>, <b>Power Apps</b>, Dataverse, <b>Dynamics 365, Power BI,</b> AR (Augmented Reality), VR (Virtual Reality), and MR (<b>Mixed Reality</b>) solutions.  
                 </p>
                 ...
                 <p>Get everything that your business needs, from Enterprise resource planning (ERP), customer relationship management (CRM), and Business Intelligence (BI) apps, such as <Link href="/products/microsoft-power-bi/">Power BI</Link> to  <Link href="/products/microsoft-dynamics-365/">Microsoft Dynamics 365</Link> add-ons like AI-powered bots and other business applications plus integrations.</p>
                 <p>Maximize the efficiency and productivity of your team beyond Microsoft's latest tech stack with <Link href="/">Dynamics Square</Link>. Discover resources and business tips to support your vision to increase ROIs.</p>
              </div>
            </div>
            <div className="col-lg-6">
