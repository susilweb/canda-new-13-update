                ...
                <div className="text-center text-lg-start">
                  <Link href="#exampleModal">
                    <a
                      ...
                      className="btn-get-started scrollto"
                    >
                      <span>Get Started with Dynamics GP Today!</span>
                    </a>
                  </Link>
                </div>
              </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="call-to-action-content">
                <h3>Looking for a Reliable Partner In Canada to Upgrade Your Dynamics GP to its 2018 or 2021 version?</h3>
                <p>Get in touch with our Dynamics experts, discuss your business needs and get help in upgrading Dynamics GP or migrating your business ops to <b>Dynamis 365 Finance</b> or <b>Supply Chain Management</b>.</p>
      ...
      <section className="">
        <div className="container">
          ...
          <div className="row pad9x">
            <div className="col-lg-5 align-self-center">
              <div className="commen-rit-info">
                <h2>What's New in Dynamics GP 18.5.xx (GP 2023)?</h2>
                <p>
                  <b>Microsoft released a new update for Dynamics GP on Oct 3, 2022. Let's explore what its new features are:</b>
                </p>
                <ul>
                  <li>Windows 11, SQL Server 2022, & Windows Server 2022 support</li>
                  <li>Filter Selected Navigation Lists using Batch ID or Batch Source</li>
                  <li>'Redisplay' function for Bank Reconciliation</li>
                  <li>Payables Batch Entry for - EFT (Electronic Funds Transfer) computer check payment or a Credit Card payment</li>
                  <li>Print, Email SOP, & POP Documents simultaneously</li>
                  <li>Set a scheduled time to run Checklinks, and more</li>
                </ul>
                <div className="cltt-actt">
                  <Link href="/contact-us/">Get Your Upgrades Now! </Link>
                </div>
              </div>
            </div>
            <div className="col-lg-7 align-self-center">
              <div className="commen-lef-pic">
                <Image
                  src="/img/gp-support-1024x630.png"
                  alt="gp-support-1024x630"
                  width={1024} height={630}
                />
              </div>
            </div>
...
export default MicrosoftDynamicsGP;
